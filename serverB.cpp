// serverB.cpp — Backend Server B
// Owns block2.txt. Communicates with the Main Server over UDP only.
//
...
// Static UDP port for Server B = 22000 + last 3 digits of USC ID (875).
...
int main() {
    ...
    my_addr.sin_port = htons(UDP_PORT_B);
